    ...
    return (
      <div className="max-w-xl mx-auto py-16 px-4 text-center">
        ...
        <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
          Como administrador da plataforma, você gerencia as oficinas clientes contratantes. As ordens de serviço e serviços de bancada são operados internamente por cada oficina.
        </p>
        <Link
          href="/dashboard"
