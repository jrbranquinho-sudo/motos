    ...
    return (
      <div className="max-w-xl mx-auto py-16 px-4 text-center">
        ...
        <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
          Como administrador da plataforma, você gerencia as oficinas clientes contratantes. O cadastro e consulta de veículos e placas é de uso exclusivo da operação de cada oficina mecânica.
        </p>
        <Link
          href="/dashboard"
